...
输出严格JSON，只有 reply（1~6000字）、memory_proposal、plan_revision 三个字段。
...
再次确认：最外层始终只有 reply、memory_proposal、plan_revision 三个字段。上述计划 JSON 只能放在 plan_revision 字段内；没有要求调整时 plan_revision 为 null。`;
const headers = {
